...
import blogAI from "@/assets/brand/blog-ai-transformation.svg";
import blogCREA from "@/assets/blog-crea-ddf.jpg";
import blogCompliance from "@/assets/blog-compliance.jpg";
import blogLeads from "@/assets/brand/blog-lead-conversion.svg";
...
import blogAIAutomation from "@/assets/brand/blog-ai-automation-realtor.svg";
...
import blogAIvsTraditional from "@/assets/brand/blog-ai-vs-traditional.svg";
...
import blogPIPEDA from "@/assets/brand/blog-pipeda-privacy.svg";
import blogLeadResponse from "@/assets/brand/blog-lead-response-time.svg";
import blogAICRMGuide from "@/assets/brand/blog-ai-crm-guide.svg";
...
const Resources = () => {
  ...
  const articles = [
    ...
    },
    {
      ...
      excerpt: "AI CRMs deliver strong ROI vs traditional CRMs. See feature-by-feature comparison, cost analysis, and why Canadian agents are switching.",
      readTime: 14,
      ...
      <section className="section-padding">
        <div className="container-custom">
          {selectedCategory === "all" ? (
            // Show All Articles in single section
            <div className="mb-16">
              <div className="mb-8">
            ...
            categoryKeys.slice(1).map((categoryKey) => {
              ...
              const shouldDisplay = selectedCategory === categoryKey;
