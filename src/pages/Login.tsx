        ...
        <div className="space-y-6">
          ...
          <form noValidate onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="flex items-center justify-end">
              <Link
                to="/forgot-password"
                className="text-sm text-violet-300 hover:text-violet-200 font-medium underline underline-offset-2 transition-colors rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-300"
              >
          ...
          <p className="text-center text-sm text-gray-300">
            ...
            <Link to="/signup" className="text-violet-300 font-medium underline underline-offset-2 hover:text-violet-200 transition-colors rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-300">
