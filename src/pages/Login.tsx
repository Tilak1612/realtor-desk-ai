        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="flex items-center justify-center px-4 py-3 border border-rd-line rounded-xl bg-white hover:bg-rd-ink-50 transition-all duration-200 hover:border-rd-line-strong hover:shadow-sm group"
            >
              ...
              <span className="ml-2 text-sm font-medium text-rd-ink-600 group-hover:text-rd-ink-900 transition-colors">Google</span>
            </button>
          </div>
          ...
          <form noValidate onSubmit={handleLogin} className="space-y-5">
            ...
            {/* Security Notice */}
            <div className="flex items-center gap-2 text-xs text-rd-ink-700 bg-rd-navy-50 p-3 rounded-lg border border-rd-line">
              <Info aria-hidden="true" className="w-4 h-4 text-rd-navy-700 flex-shrink-0" />
