  ...
  return (
    <section className="relative pt-20 sm:pt-24 md:pt-28 lg:pt-36 pb-12 sm:pb-16 md:pb-20 lg:pb-28 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-10 left-[5%] w-16 h-16 rounded-full bg-[hsl(var(--decorative-purple))] opacity-30 blur-2xl animate-pulse" style={{ animationDelay: '0s', animationDuration: '3s' }} />
        <div className="absolute top-[15%] right-[8%] w-32 h-32 rounded-full bg-[hsl(var(--decorative-orange))] opacity-40 blur-3xl animate-pulse" style={{ animationDelay: '0.5s', animationDuration: '4s' }} />
        <div className="absolute top-[40%] left-[3%] w-24 h-24 rounded-full bg-[hsl(var(--decorative-blue))] opacity-35 blur-2xl animate-pulse" style={{ animationDelay: '1s', animationDuration: '3.5s' }} />
        <div className="absolute bottom-[20%] left-[10%] w-20 h-20 rounded-full bg-[hsl(var(--decorative-pink))] opacity-30 blur-2xl animate-pulse" style={{ animationDelay: '1.5s', animationDuration: '4s' }} />
        <div className="absolute bottom-[30%] right-[5%] w-40 h-40 rounded-full bg-[hsl(var(--decorative-yellow))] opacity-25 blur-3xl animate-pulse" style={{ animationDelay: '2s', animationDuration: '5s' }} />
        <div className="absolute top-[60%] left-[45%] w-12 h-12 rounded-full bg-[hsl(var(--decorative-green))] opacity-35 blur-xl animate-pulse" style={{ animationDelay: '0.8s', animationDuration: '3s' }} />
        <div className="absolute bottom-10 right-[15%] w-28 h-28 rounded-full bg-[hsl(var(--decorative-purple))] opacity-20 blur-3xl animate-pulse" style={{ animationDelay: '1.2s', animationDuration: '4.5s' }} />
      </div>
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 mb-4 sm:mb-6 animate-fade-in-up">
          ...
          {/* Main Title */}
          <h1 className="mb-4 sm:mb-6 leading-[1.1] text-foreground text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold animate-fade-in-up animation-delay-200 max-w-4xl mx-auto">
            {t('hero.title')}
          </h1>
