        ...
        {properties.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-muted-foreground mb-4">
              No properties tracked yet. Add properties this contact is interested in.
            </p>
            <Button>
              <Plus className="h-4 w-4 mr-2" />
              Add First Property
            ...
            {properties.map((property) => (
              ...
              >
                <div className="flex items-start justify-between gap-2">
                  ...
                  <Badge className={getInterestColor(property.interest_level)}>
                ...
                <div className="flex items-center justify-between text-xs text-muted-foreground">
                  {property.viewed_date && (
                    <span>
                      Viewed: {format(new Date(property.viewed_date), "MMM d, yyyy")}
                    </span>
                  )}
