  ...
  en: {
    translation: {
      ...
      featuresRd: {
        ...
        capCalendarBody: "Two-way sync with Google Calendar and Outlook, so showings sit on the calendar you already use.",
        capContactsTitle: "Contact import",
        capContactsBody: "Bring contacts across from Google or Microsoft, or upload a CSV.",
  ...
  fr: {
    translation: {
      ...
      featuresRd: {
        ...
        capCalendarBody: "Synchronisation bidirectionnelle avec Google Agenda et Outlook : les visites se retrouvent dans le calendrier que vous utilisez déjà.",
        capContactsTitle: "Import de contacts",
        capContactsBody: "Importez vos contacts depuis Google ou Microsoft, ou téléversez un fichier CSV.",
