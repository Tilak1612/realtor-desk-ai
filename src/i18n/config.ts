  ...
  en: {
    translation: {
      ...
      featuresRd: {
        ...
        pillar1Tag2: "Replies day or night",
        ...
        pillar2Tag2: "Next-best action per lead",
        pillar2Tag3: "CRM since 2020",
        pillar3Cat: "Built for Canada",
        pillar3Title: "PIPEDA-native. CASL-aware. Provincially-ready.",
        pillar3Body: "Canadian data stays in Canadian data centres. Consent is captured at first touch, recorded, and revocable — an unsubscribe is honoured immediately and permanently.",
  ...
  fr: {
    translation: {
      ...
      featuresRd: {
        ...
        pillar1Tag2: "Répond jour et nuit",
        ...
        pillar2Tag2: "Action suivante par prospect",
        ...
        pillar3Body: "Les données canadiennes restent dans des centres de données canadiens. Le consentement est capturé dès le premier contact, enregistré et révocable — un désabonnement est honoré immédiatement et définitivement.",
        pillar3Tag1: "AWS ca-central-1",
