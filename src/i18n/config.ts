  ...
  en: {
    translation: {
      nav: {
        ...
        notificationsUnavailable: "Couldn't load notifications",
        taskOverdue: "Overdue",
      ...
      landing: {
        hero: {
          ...
          trustSetup: "Data hosted in Canada",
          trustDdf: "Realtor.ca listing import"
        },
        productTour: {
        ...
        featureGrid: {
          ...
          heading: "Built around how Canadian agents actually work.",
          intro: "Six things the desk does, in one console — no plugins, no duct-taped integrations.",
          meetDeskAi: "Meet Desk AI",
          chatbotTitle: "An AI assistant inside your desk",
          chatbotDesc: "Open a lead and ask. It can see that contact, draft a reply, summarise the thread and talk through your next move — in English or French.",
          bilingualTitle: "Bilingual EN · FR",
          bilingualDesc: "The whole desk runs in either language — the app, your emails, and every lead record. Set a language per contact and it stays there.",
          pipedaTitle: "Canadian by default",
          pipedaDesc: "Your data is hosted in Canada. Consent date and source are recorded on every contact, and an unsubscribe is honoured immediately and permanently.",
          pipelineTitle: "Pipeline that moves",
          pipelineDesc: "Drag a lead between stages and it sticks. Every column carries its own count and CAD value, so you can see where the money actually sits.",
          scoringTitle: "Lead scoring",
          scoringDesc: "Intent, urgency, budget and timeline roll up to a 0–100 score — with the factors behind it and a suggested next action on the lead.",
          inboxTitle: "One thread per lead",
          inboxDesc: "Every message with a lead sits on a single timeline beside their record: what was said, when, and by whom. Nothing buried in a personal inbox."
        },
        pipelinePreview: {
          eyebrow: "The morning read",
          heading: "Open the board and the day is already sorted.",
          body: "Leads carry their score and stage, so the ones worth a call sit at the top. Open one and the whole history is there — every message, note and task on a single timeline.",
      ...
      pricingRd: {
        ...
        planSoloDesc: "Everything a single agent needs to run their whole book.",
        ...
        featSoloCasl: "CASL email footer + instant unsubscribe",
        featSoloUser: "1 user",
        featTeamAiUnl: "Unlimited AI messages",
        featTeamDdfUnl: "CREA DDF® feed, unlimited boards (Q3 2026)",
        featTeamRouting: "Round-robin lead routing (roadmap)",
        featTeamReports: "Team reports & leaderboard",
        featTeamSeats: "5 users included",
        featBrokerageSso: "SAML SSO + Azure AD (roadmap)",
        featBrokerageCompliance: "FINTRAC & provincial regulator workflows (roadmap)",
        featBrokerageDdfCustom: "Custom DDF mappings (Q3 2026)",
        featBrokerageCsm: "Dedicated Canadian CSM",
        featBrokerageSla: "Uptime commitment, agreed in your contract",
      ...
      featuresRd: {
        ...
        heroH1Mid: ", in one",
        heroH1Italic2: "place",
        heroSubtitle: "Realtor Desk is a bilingual CRM for Canadian real estate. Rank your leads, keep every conversation on one timeline, move deals across a pipeline, and report on all of it in CAD.",
        pillar1Cat: "Lead intelligence",
        pillar1Title: "A ranked list, not an inbox",
        pillar1Body: "Intent, urgency, budget and timeline roll up to a 0-100 score on every lead — with the factors behind that score and a suggested next action. The ones worth calling sit at the top of the board.",
        pillar1Tag1: "0-100 lead score",
        pillar1Tag2: "The factors behind it",
        pillar1Tag3: "Suggested next action",
        pillar2Cat: "The client record",
        pillar2Title: "One timeline per client",
        pillar2Body: "Messages, notes, tasks and listing interest all sit beside the contact rather than in someone's personal inbox. Drag a lead across the pipeline and every column keeps its own count and CAD value.",
        pillar2Tag1: "Single conversation thread",
        pillar2Tag2: "Drag-and-drop pipeline",
        pillar2Tag3: "CAD value per stage",
        pillar3Cat: "Built for Canada",
        pillar3Title: "Hosted in Canada. Bilingual throughout. Consent on the record.",
        pillar3Body: "Your data stays in a Canadian region. Consent date and source are written onto every contact, and an unsubscribe is honoured immediately and permanently. Prices and reporting are in CAD.",
        pillar3Tag1: "Canadian region (ca-central-1)",
        pillar3Tag2: "Instant unsubscribe",
        pillar3Tag3: "Bilingual EN/FR",
        capsEyebrow: "Everything else",
        capsHeading1: "The plumbing,",
        capsHeadingItalic: "labelled honestly",
        capsIntro: "What is switched on today, and what we are still building. You should know which is which before you pay us.",
        capsNowLabel: "Available today",
        capsRoadmapLabel: "On the roadmap",
        capsRoadmapBadge: "Roadmap",
        capImportTitle: "Realtor.ca listing import",
        capImportBody: "Paste a Realtor.ca listing URL or an MLS number and the property details come into the CRM.",
        capCalendarTitle: "Calendar sync",
        capCalendarBody: "Connect Google Calendar or Outlook today; syncing appointments both ways is in build.",
        capContactsTitle: "Contact import",
        capContactsBody: "Upload a CSV today. Importing straight from Google or Microsoft is in build.",
        capWebhooksTitle: "Lead capture webhooks",
        capWebhooksBody: "Point Zapier, Make or n8n at your desk and new leads arrive as contacts, de-duplicated by email.",
        capSmsTitle: "SMS",
        capSmsBody: "Send SMS through your own Twilio account, with consent recorded per number.",
        capConsentTitle: "Consent & unsubscribe",
        capConsentBody: "Consent date and source on every contact. An unsubscribe is honoured immediately and permanently.",
        capReportingTitle: "Reporting",
        capReportingBody: "Response time, deals closed, stage conversion and lead source — in CAD throughout.",
        capBilingualTitle: "Bilingual EN · FR",
        capBilingualBody: "The app, your emails and every lead record run in either language. Set it per contact.",
        capDdfTitle: "CREA DDF® sync",
        capDdfBody: "Listings pulled straight from your board. Waiting on CREA credentials; targeted for Q3 2026.",
        capSequencesTitle: "Automated email sequences",
        capSequencesBody: "The sequence builder — email, wait, tag, task — is in the app today. Scheduled sending is not switched on yet.",
        capChatTitle: "Website chat widget",
        capChatBody: "A drop-in script for your own site that files enquiries straight into your desk.",
        capRoutingTitle: "Team routing",
        capRoutingBody: "Round-robin assignment by geography, language or listing type.",
        capRolesTitle: "Roles & audit log",
        capRolesBody: "Granular team permissions, and an exportable record of who touched which lead.",
        ctaH1Pre: "Free for 14 days.",
        ctaH1Italic: "Cancel anytime.",
        ctaBody: "Create your account, import your contacts and work a real lead end to end. A card is collected at checkout to start the trial; nothing is charged before day 14.",
      ...
      auth: {
        ...
        signup: {
          ...
          aside: {
            headline: "The Canadian real estate CRM, in English and French.",
            sub: "Score your leads, keep every conversation on one timeline, and move deals across a pipeline built for showings, offers and closings.",
            b1: "Leads arrive from your website forms, ads and tools via Zapier, Make or n8n — de-duplicated into one list.",
            b2: "A 0-100 score on every lead, with the factors behind it and a suggested next action.",
            b3: "A contact and deal pipeline built for showings, offers, and closings.",
            b4: "Ask the in-app assistant to draft a reply in your lead's language, in English or French.",
  ...
  fr: {
    translation: {
      nav: {
        ...
        notificationsUnavailable: "Impossible de charger les notifications",
      ...
      landing: {
        hero: {
          ...
          trustSetup: "Données hébergées au Canada",
          trustDdf: "Import de fiches Realtor.ca"
        },
        productTour: {
        ...
        featureGrid: {
          ...
          heading: "Conçu pour la façon dont travaillent vraiment les courtiers canadiens.",
          intro: "Six choses que fait ce bureau, dans une seule console — sans module ni intégration bricolée.",
          meetDeskAi: "Rencontrer Desk IA",
          chatbotTitle: "Un assistant IA dans votre bureau",
          chatbotDesc: "Ouvrez une fiche et posez votre question. Il voit ce contact, rédige une réponse, résume le fil et discute de la suite — en français ou en anglais.",
          bilingualTitle: "Bilingue FR · EN",
          bilingualDesc: "Tout le bureau fonctionne dans l'une ou l'autre langue — l'application, vos courriels et chaque fiche. Choisissez la langue d'un contact et elle y reste.",
          pipedaTitle: "Canadien par défaut",
          pipedaDesc: "Vos données sont hébergées au Canada. La date et la source du consentement sont inscrites sur chaque contact, et un désabonnement est honoré immédiatement et définitivement.",
          pipelineTitle: "Un pipeline qui avance",
          pipelineDesc: "Glissez une fiche d'une étape à l'autre et le changement est enregistré. Chaque colonne affiche son nombre de fiches et sa valeur en CAD.",
          scoringTitle: "Notation des prospects",
          scoringDesc: "Intention, urgence, budget et échéancier donnent un score de 0 à 100 — avec les facteurs derrière ce score et une prochaine action suggérée.",
          inboxTitle: "Un seul fil par prospect",
          inboxDesc: "Chaque message échangé avec un prospect figure sur une seule chronologie, à côté de sa fiche : ce qui a été dit, quand et par qui."
        },
        pipelinePreview: {
          eyebrow: "Lecture du matin",
          heading: "Ouvrez le tableau : la journée est déjà classée.",
          body: "Chaque fiche porte son score et son étape, donc celles qui méritent un appel sont en haut. Ouvrez-en une et tout l'historique est là — messages, notes et tâches sur une seule chronologie.",
      ...
      pricingRd: {
        ...
        planSoloDesc: "Tout ce qu'il faut à un courtier seul pour gérer tout son portefeuille.",
        ...
        featSoloCasl: "Pied de page LCAP + désabonnement instantané",
        ...
        featTeamRouting: "Distribution round-robin des prospects (feuille de route)",
        featTeamReports: "Rapports d'équipe et classement",
        featTeamSeats: "5 utilisateurs inclus",
        featBrokerageSso: "SAML SSO + Azure AD (feuille de route)",
        featBrokerageCompliance: "Flux CANAFE et régulateurs provinciaux (feuille de route)",
        featBrokerageDdfCustom: "Mappages SDD personnalisés (T3 2026)",
        featBrokerageCsm: "Gestion de compte canadienne dédiée",
        featBrokerageSla: "Engagement de disponibilité, convenu au contrat",
      ...
      featuresRd: {
        ...
        heroH1Italic1: "prospect",
        heroH1Mid: ", au même",
        heroH1Italic2: "endroit",
        heroSubtitle: "Realtor Desk est un CRM bilingue pour l'immobilier canadien. Classez vos prospects, gardez chaque échange sur une seule chronologie, faites avancer vos transactions dans un pipeline et suivez le tout en CAD.",
        pillar1Cat: "Intelligence des prospects",
        pillar1Title: "Une liste classée, pas une boîte de réception",
        pillar1Body: "L'intention, l'urgence, le budget et l'échéancier donnent un score de 0 à 100 sur chaque fiche — avec les facteurs derrière ce score et une prochaine action suggérée. Celles qui méritent un appel sont en haut du tableau.",
        pillar1Tag1: "Score de 0 à 100",
        pillar1Tag2: "Les facteurs derrière le score",
        pillar1Tag3: "Prochaine action suggérée",
        pillar2Cat: "La fiche client",
        pillar2Title: "Une chronologie par client",
        pillar2Body: "Messages, notes, tâches et intérêts pour des inscriptions sont réunis à côté du contact plutôt que dans la boîte de réception de quelqu'un. Glissez une fiche dans le pipeline : chaque colonne garde son nombre de fiches et sa valeur en CAD.",
        pillar2Tag1: "Un seul fil de conversation",
        pillar2Tag2: "Pipeline glisser-déposer",
        pillar2Tag3: "Valeur en CAD par étape",
        pillar3Cat: "Conçu pour le Canada",
        pillar3Title: "Hébergé au Canada. Bilingue partout. Consentement consigné.",
        pillar3Body: "Vos données restent dans une région canadienne. La date et la source du consentement sont inscrites sur chaque contact, et un désabonnement est honoré immédiatement et définitivement. Les prix et les rapports sont en CAD.",
        pillar3Tag1: "Région canadienne (ca-central-1)",
        pillar3Tag2: "Désabonnement instantané",
        pillar3Tag3: "Bilingue FR/EN",
        capsEyebrow: "Tout le reste",
        capsHeading1: "La plomberie,",
        capsHeadingItalic: "étiquetée honnêtement",
        capsIntro: "Ce qui est actif aujourd'hui, et ce que nous construisons encore. Vous devriez savoir lequel est lequel avant de payer.",
        capsNowLabel: "Disponible aujourd'hui",
        capsRoadmapLabel: "À la feuille de route",
        capsRoadmapBadge: "Feuille de route",
        capImportTitle: "Import de fiches Realtor.ca",
        capImportBody: "Collez un lien de fiche Realtor.ca ou un numéro MLS et les détails de la propriété entrent dans le CRM.",
        capCalendarTitle: "Synchronisation du calendrier",
        capCalendarBody: "Connectez Google Agenda ou Outlook dès aujourd'hui; la synchronisation des rendez-vous dans les deux sens est en cours de développement.",
        capContactsTitle: "Import de contacts",
        capContactsBody: "Téléversez un fichier CSV dès aujourd'hui. L'import direct depuis Google ou Microsoft est en cours de développement.",
        capWebhooksTitle: "Webhooks de capture de prospects",
        capWebhooksBody: "Branchez Zapier, Make ou n8n et les nouveaux prospects arrivent comme contacts, dédoublonnés par courriel.",
        capSmsTitle: "SMS",
        capSmsBody: "Envoyez des SMS via votre propre compte Twilio, avec le consentement consigné par numéro.",
        capConsentTitle: "Consentement et désabonnement",
        capConsentBody: "Date et source du consentement sur chaque contact. Un désabonnement est honoré immédiatement et définitivement.",
        capReportingTitle: "Rapports",
        capReportingBody: "Temps de réponse, transactions conclues, conversion par étape et source des prospects — en CAD partout.",
        capBilingualTitle: "Bilingue FR · EN",
        capBilingualBody: "L'application, vos courriels et chaque fiche fonctionnent dans l'une ou l'autre langue. Réglable par contact.",
        capDdfTitle: "Synchronisation SDD® de l'ACI",
        capDdfBody: "Inscriptions tirées directement de votre chambre. En attente des accès de l'ACI; visé pour le T3 2026.",
        capSequencesTitle: "Séquences courriel automatisées",
        capSequencesBody: "Le constructeur de séquences — courriel, délai, étiquette, tâche — est dans l'application. L'envoi planifié n'est pas encore activé.",
        capChatTitle: "Widget de clavardage Web",
        capChatBody: "Un script à déposer sur votre site qui achemine les demandes directement dans votre bureau.",
        capRoutingTitle: "Distribution d'équipe",
        capRoutingBody: "Attribution en rotation selon la géographie, la langue ou le type d'inscription.",
        capRolesTitle: "Rôles et journal d'audit",
        capRolesBody: "Permissions d'équipe granulaires et un registre exportable de qui a touché quelle fiche.",
        ctaH1Pre: "Gratuit pendant 14 jours.",
        ctaH1Italic: "Annulez à tout moment.",
        ctaBody: "Créez votre compte, importez vos contacts et travaillez un vrai prospect de bout en bout. Une carte est demandée au paiement pour démarrer l'essai; rien n'est facturé avant le 14e jour.",
      ...
      billing: {
        ...
        agentPlan: "Forfait Solo",
        teamPlan: "Forfait Équipe",
        brokeragePlan: "Forfait Agence",
        subscribed: "Abonné",
        ...
        agentDesc: "Pour l'agent autonome",
        teamDesc: "Pour 2 à 10 courtiers",
        brokerageDesc: "Pour 10 courtiers et plus",
        customPrice: "Sur mesure",
        contactSales: "Nous contacter",
        brokerageBlurb: "SSO, gestion de compte dédiée, outils CANAFE personnalisés et SLA.",
        switchAgent: "Passer au forfait Solo",
        upgradeAgent: "Passer au forfait Solo",
        ...
        features: {
          ...
          everythingAgent: "Tout le forfait Solo, plus :",
      ...
      auth: {
        ...
        signup: {
          ...
          aside: {
            headline: "Le CRM immobilier canadien, en français et en anglais.",
            sub: "Notez vos prospects, gardez chaque échange sur une seule chronologie et faites avancer vos transactions dans un pipeline conçu pour les visites, les offres et les clôtures.",
            b1: "Les prospects arrivent de vos formulaires web, de vos publicités et de vos outils via Zapier, Make ou n8n — dédoublonnés en une seule liste.",
            b2: "Un score de 0 à 100 sur chaque prospect, avec les facteurs derrière ce score et une prochaine action suggérée.",
            b3: "Un pipeline de contacts et de transactions conçu pour les visites, les offres et les clôtures.",
            b4: "Demandez à l'assistant intégré de rédiger une réponse dans la langue du prospect, en français ou en anglais.",
